<x-app-layout>
        ...
        <div class="d-flex justify-content-center align-items-center"
            ...
            <div class="card-body bg-light" style="margin: 1rem; border-radius: 1rem;">
                ...
                <div class="text-right mb-3" style="color:white">
                    <a href="{{ url('panel/urunler/create') }}" method="get" class="btn btn-success"
                        style="background-color: #415a77;">Ürün Ekle</a>
                </div>
                ...
                <table class="table" style="color:white">
                    ...
                    <tbody>
                        @foreach ($urunler->reverse() as $key => $value)
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item"
                                                href="{{ url('panel/urunler/edit/' . $value->id) }}">Düzenle</a>
                                            <!-- Silme Butonu -->
                                            <a class="dropdown-item sil-btn" href="#"
                                                data-id="{{ $value->id }}"
                                                onclick="deleteUrunler('{{ url('panel/urunler/delete/' . $value->id) }}')">Sil</a>

                                            <script>
                                                // Global kapsamda confirmDelete fonksiyonunu tanımla
                                                var confirmDelete;

                                                function deleteUrunler(url) {
                                                    // Silme modalını aç
                                                    $('#deleteUrunlerModal').modal('show');
    ...
    <!-- Silme Modalı -->
    <div class="modal fade" id="deleteUrunlerModal" tabindex="-1" aria-labelledby="deleteUrunlerModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteUrunlerModalLabel">
                        Ürünü Sil</h5>
...
<script>
    $('.sil-btn').on("click", function() {
        ...
        $(".sil-onay").attr('href', "/panel/urunler/delete/" + id);
