                ...
                <div class="card-body bg-light" style="margin: 1rem; border-radius: 1rem;">
                    ...
                    <form action="{{ route('panel.news.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="slug" class="news_slug">
                        </div>
                        ...
                        <div class="form-group">
                            <label for="kapak_foto">Haber Kapak Fotoğrafı</label>
                            <input type="file" class="form-control" name="kapak_foto" id="kapak_foto">
                        </div>

                        <div class="form-group">
                            <label for="kapak_foto">Haber Fotoğrafları</label>
                            <input type="file" class="form-control" name="images[]" id="images" multiple>
                        </div>

                        <div class="form-group">
                            <label for="contents">Haber İçeriği</label>
                            <textarea class="form-control" name="contents" id="news_icerik" rows="4"></textarea>
                        </div>
