<x-app-layout>
    <x-slot name="header">
        ...
        {{-- bootstrap linkini buraya eklemek sıkıntı mı --}}
    </x-slot>
    <div class="py-12">
                ...
                <div class="card-body bg-light" style="margin: 1rem; border-radius: 1rem;">
                    ...
                    <form action="{{ route('panel.blog.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="slug" class="blog_slug">
                        </div>
                        ...
                        <div class="form-group">
                            <label for="kapak_foto">Blog Kapak Fotoğrafı</label>
                            <input type="file" class="form-control" name="kapak_foto" id="kapak_foto">
                        </div>

                        <div class="form-group">
                            <label for="kapak_foto">Blog Fotoğrafları</label>
                            <input type="file" class="form-control" name="images[]" id="images" multiple>
                        </div>

                        <div class="form-group">
                            <label for="contents">Blog İçeriği</label>
                            <textarea class="form-control" name="contents" id="blog_icerik" rows="4"></textarea>
                        </div>
