        ...
        <div class="d-flex justify-content-center align-items-center"
            ...
            <div class="card-body bg-light" style="margin: 1rem; border-radius: 1rem;">
                ...
                <div class="text-right mb-3" style="color:white">
                    <a href="{{ url('panel/blog/create') }}" method="get" class="btn btn-success"
                        style="background-color: #415a77;">Blog Ekle</a>
                </div>
                ...
                <table class="table" style="color:white">
                    ...
                    <tbody>
                        @foreach ($blog->reverse() as $key => $value)
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item"
                                                href="{{ url('panel/blog/edit/' . $value->id) }}">Düzenle</a>

                                            <!-- Silme Butonu -->
                                            <a class="dropdown-item sil-btn" href="#" data-id="{{ $value->id }}"
                                                onclick="deleteBlog('{{ url('panel/blog/delete/' . $value->id) }}')">Sil</a>
...
<script>
    $('.sil-btn').on("click", function() {
        ...
        $(".sil-onay").attr('href', "/panel/blog/delete/" + id);
